...
async function main() {
  console.log('\n🚀 Starting budget quote migrations via Management API...\n');

  const migrations = [
    {
      file: 'supabase/migrations/20251028032729_add_budget_quote_line_items.sql',
      name: 'add_budget_quote_line_items'
    },
    {
      file: 'supabase/migrations/20251028032730_create_project_quotes_storage_bucket.sql',
      name: 'create_project_quotes_storage_bucket'
    }
  ];
  ...
  if (success > 0) {
    console.log('\n✅ Migrations applied! Budget quote features are now live in production.\n');
  } else {
